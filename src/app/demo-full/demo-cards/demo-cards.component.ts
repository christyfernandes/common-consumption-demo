...
export class DemoCardsComponent implements OnInit {
  ...
  desktopTextBookCard: LibraryCardTypes = LibraryCardTypes.DESKTOP_TEXTBOOK;
  mobileTextBookCard: LibraryCardTypes = LibraryCardTypes.MOBILE_TEXTBOOK;
  ...
  constructor(public appSharedService: AppSharedService, private router: Router, private route:ActivatedRoute) { }
